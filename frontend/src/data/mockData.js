// ============================================================
// mockData.js — Datos iniciales para desarrollo sin backend.
// Cuando el backend esté listo, este archivo se elimina y los
// services apuntan a la API real.
// ============================================================
...
/** @type {Object.<string, import('../types').WeeklyProgress>} */
export const MOCK_PROGRESS = Object.fromEntries(
  MOCK_CHARACTERS.map((c, i) => [
    c.id,
    { id: `p${i + 1}`, ...createEmptyProgress(c.id, CURRENT_WEEK) },
  ])
);
